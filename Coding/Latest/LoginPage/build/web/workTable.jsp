...
<body id="page-top">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Shift Tracker</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Employees on Shift</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
    ...
    <img class="company-logo-work-table" src="assetsJSP/css/images/CompanyLogo.png" height="600" width="600">
