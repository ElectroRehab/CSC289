...
<head>
    ...
    'report-sample'; style-src 'report-sample' 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://fonts.googleapis.com https://drive.google.com/uc?export=view&id=1AhrTHw6xzWn-AOOxnNsPlKyZLX3l9g3i; 
    img-src 'self'https://drive.google.com/uc?export=view&id=1AhrTHw6xzWn-AOOxnNsPlKyZLX3l9g3i data; base-uri 'self'; object-src 'self';
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Administrator Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
    ...
    %>
        ...
        <%while(rs.next())
        {
            ...
            %>               
            <tr>
                <td><img src="<%=rs.getString("imageID")%>" alt="accountIcon" width= "60"  height="60"></td>
    ...
    %>
            ...
            <img class="company-logo-user-table" src="assetsJSP/css/images/CompanyLogo.png" height="600" width="600">
